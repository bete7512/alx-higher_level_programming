...
-   **Auto QA review:**  103.15/116 mandatory & 0.0/29 optional
-   **Altogether:**  **88.92%**
    -   Mandatory: 88.92%
    -   Optional: 0.0%
    -   Calculation: 88.92% + (88.92% * 0.0%) == **88.92%**
...
-   [Object-oriented JavaScript](https://alx-intranet.hbtn.io/rltoken/qqgqdyHPzUZkKQ5UMnw2MQ "Object-oriented JavaScript")  (_**read all examples!**_)
...
Score:  95.00%  (Checks completed: 100.00%)
...
Score:  96.82%  (Checks completed: 100.00%)
...
Score:  78.64%  (Checks completed: 81.82%)
...
Score:  96.50%  (Checks completed: 100.00%)
